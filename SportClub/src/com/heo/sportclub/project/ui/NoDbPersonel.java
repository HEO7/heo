...
public class NoDbPersonel extends JFrame {
	...
	public NoDbPersonel() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(NoDbPersonel.class.getResource("/images/sport-club-logo.jpg")));
	...
	private void initialize() {
		...
		btnkaydet.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (perdao.save(kaydet)) {
					JOptionPane.showMessageDialog(NoDbPersonel.this, "Kayýt Baþarýlý.");
				}
				else {
					JOptionPane.showMessageDialog(NoDbPersonel.this, "Kayýt Baþarýsýz.");
				}
		...
		btnPersoneller.setEnabled(false);
