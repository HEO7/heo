...
public class NoDbMemReg extends JFrame {
	...
	public NoDbMemReg() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(NoDbMemReg.class.getResource("/images/sport-club-logo.jpg")));
		...
		btnKaydet.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
			    ...
			    if (memdao.save(kaydet)) {
					JOptionPane.showMessageDialog(NoDbMemReg.this, "Kayýt Baþarýlý");
			    	
				}
			    else {
			    	JOptionPane.showMessageDialog(NoDbMemReg.this, "Kayýt Baþarýsýz.");
				}
